...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__LiveAnaly__ETL_C__56C2C32C] DEFAULT (getdate()),
...
GO
ALTER TABLE [stg].[LiveAnalytics_Behavior] ADD CONSTRAINT [PK__LiveAnal__7EF6BFCD7CCC8052] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
