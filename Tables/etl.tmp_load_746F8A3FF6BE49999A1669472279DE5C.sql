CREATE TABLE [etl].[tmp_load_746F8A3FF6BE49999A1669472279DE5C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_746F8A3FF6BE49999A1669472279DE5C_ss] ON [etl].[tmp_load_746F8A3FF6BE49999A1669472279DE5C] ([SourceSystem], [SSID])
GO
