CREATE TABLE [segmentation].[SegmentationFlatDatac4277eb4-8ca4-498d-a438-f90a91c8945f]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatac4277eb4-8ca4-498d-a438-f90a91c8945f] ADD CONSTRAINT [pk_SegmentationFlatDatac4277eb4-8ca4-498d-a438-f90a91c8945f] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatac4277eb4-8ca4-498d-a438-f90a91c8945f] ON [segmentation].[SegmentationFlatDatac4277eb4-8ca4-498d-a438-f90a91c8945f] ([_rn])
GO
