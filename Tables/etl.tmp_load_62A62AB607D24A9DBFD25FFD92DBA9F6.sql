CREATE TABLE [etl].[tmp_load_62A62AB607D24A9DBFD25FFD92DBA9F6]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_62A62AB607D24A9DBFD25FFD92DBA9F6_ss] ON [etl].[tmp_load_62A62AB607D24A9DBFD25FFD92DBA9F6] ([SourceSystem], [SSID])
GO
