...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_C__32616E72] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_U__335592AB] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_I__3449B6E4] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_Contact] ADD CONSTRAINT [PK__Eloqua_C__3214EC279D6DDDF3] PRIMARY KEY CLUSTERED  ([ID])
GO
