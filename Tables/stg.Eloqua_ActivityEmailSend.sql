CREATE TABLE [stg].[Eloqua_ActivityEmailSend]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__4D1564AE] DEFAULT (getdate()),
[ID] [bigint] NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_Key] ON [stg].[Eloqua_ActivityEmailSend] ([ID])
GO
