CREATE TABLE [etl].[tmp_load_8F0AC0015B784C119590A9DE8A5FBDB4]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_8F0AC0015B784C119590A9DE8A5FBDB4_ss] ON [etl].[tmp_load_8F0AC0015B784C119590A9DE8A5FBDB4] ([SourceSystem], [SSID])
GO
