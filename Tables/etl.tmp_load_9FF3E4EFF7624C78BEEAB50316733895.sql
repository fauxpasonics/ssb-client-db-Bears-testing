CREATE TABLE [etl].[tmp_load_9FF3E4EFF7624C78BEEAB50316733895]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_9FF3E4EFF7624C78BEEAB50316733895_ss] ON [etl].[tmp_load_9FF3E4EFF7624C78BEEAB50316733895] ([SourceSystem], [SSID])
GO
