CREATE TABLE [etl].[tmp_load_1144717733324E03A75929459ECE6695]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1144717733324E03A75929459ECE6695_ss] ON [etl].[tmp_load_1144717733324E03A75929459ECE6695] ([SourceSystem], [SSID])
GO
