...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Creat__67A4CD19] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Updat__6898F152] DEFAULT (getdate()),
