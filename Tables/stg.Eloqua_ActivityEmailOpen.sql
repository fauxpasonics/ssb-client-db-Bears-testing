CREATE TABLE [stg].[Eloqua_ActivityEmailOpen]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__17AD7836] DEFAULT (getdate()),
[ID] [bigint] NOT NULL,
...
GO
ALTER TABLE [stg].[Eloqua_ActivityEmailOpen] ADD CONSTRAINT [PK__Eloqua_A__3214EC27E5DE4CFD] PRIMARY KEY CLUSTERED  ([ID])
GO
