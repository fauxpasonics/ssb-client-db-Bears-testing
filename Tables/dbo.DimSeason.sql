...
GO
ALTER TABLE [dbo].[DimSeason] ADD CONSTRAINT [PK_DimSeason] PRIMARY KEY NONCLUSTERED  ([DimSeasonId])
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_dbo__DimSeason] ON [dbo].[DimSeason]
GO
