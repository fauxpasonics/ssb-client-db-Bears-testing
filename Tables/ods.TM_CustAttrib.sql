...
GO
CREATE NONCLUSTERED INDEX [IDX_acct_id] ON [ods].[TM_CustAttrib] ([acct_id])
GO
CREATE NONCLUSTERED INDEX [IDX_attrib_id] ON [ods].[TM_CustAttrib] ([attrib_id])
GO
CREATE NONCLUSTERED INDEX [IDX_attrib_name] ON [ods].[TM_CustAttrib] ([attrib_name])
GO
CREATE NONCLUSTERED INDEX [IDX_attrib_value] ON [ods].[TM_CustAttrib] ([attrib_value])
GO
