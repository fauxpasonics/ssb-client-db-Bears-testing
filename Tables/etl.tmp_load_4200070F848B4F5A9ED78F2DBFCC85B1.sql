CREATE TABLE [etl].[tmp_load_4200070F848B4F5A9ED78F2DBFCC85B1]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_4200070F848B4F5A9ED78F2DBFCC85B1_ss] ON [etl].[tmp_load_4200070F848B4F5A9ED78F2DBFCC85B1] ([SourceSystem], [SSID])
GO
