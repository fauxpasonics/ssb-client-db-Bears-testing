CREATE TABLE [etl].[tmp_load_1D983799437043DEBE01FAB3B3EC0D11]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1D983799437043DEBE01FAB3B3EC0D11_ss] ON [etl].[tmp_load_1D983799437043DEBE01FAB3B3EC0D11] ([SourceSystem], [SSID])
GO
