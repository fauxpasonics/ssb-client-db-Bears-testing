CREATE TABLE [etl].[tmp_load_60D3CDE0D9D14F4085ABEDFAD4190FF7]
(
...
[ExtAttribute8] [varchar] (104) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_load_60D3CDE0D9D14F4085ABEDFAD4190FF7_ss] ON [etl].[tmp_load_60D3CDE0D9D14F4085ABEDFAD4190FF7] ([SourceSystem], [SSID])
GO
