CREATE TABLE [etl].[tmp_load_1198C0CBBD5446E8AC0165FC97534C15]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_1198C0CBBD5446E8AC0165FC97534C15_ss] ON [etl].[tmp_load_1198C0CBBD5446E8AC0165FC97534C15] ([SourceSystem], [SSID])
GO
