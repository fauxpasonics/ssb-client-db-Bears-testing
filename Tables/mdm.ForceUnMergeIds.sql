...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Creat__698D158B] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Updat__6A8139C4] DEFAULT (getdate()),
