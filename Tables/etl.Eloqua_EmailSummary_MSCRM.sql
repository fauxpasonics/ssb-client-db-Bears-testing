CREATE TABLE [etl].[Eloqua_EmailSummary_MSCRM]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_Eloqua_EmailSummary_MSCRM__SSB_CRMSYSTEM_CONTACT_ID] ON [etl].[Eloqua_EmailSummary_MSCRM] ([SSB_CRMSYSTEM_CONTACT_ID])
GO
