CREATE TABLE [etl].[tmp_load_7545C127C8094630897B1EC12CE6FBB0]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_7545C127C8094630897B1EC12CE6FBB0_ss] ON [etl].[tmp_load_7545C127C8094630897B1EC12CE6FBB0] ([SourceSystem], [SSID])
GO
