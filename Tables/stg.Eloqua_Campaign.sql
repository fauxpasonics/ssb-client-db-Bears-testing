CREATE TABLE [stg].[Eloqua_Campaign]
(
[ETL_ID] [int] NOT NULL IDENTITY(1, 1),
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_C__100C566E] DEFAULT (getdate()),
[ID] [int] NOT NULL,
...
GO
ALTER TABLE [stg].[Eloqua_Campaign] ADD CONSTRAINT [PK__Eloqua_C__3214EC27457903BB] PRIMARY KEY CLUSTERED  ([ID])
GO
