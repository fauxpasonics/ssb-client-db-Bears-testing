...
--base set
        SELECT
            ...
            , CONVERT(VARCHAR(30),z.C_Birthdate1, 102) AS [Birthday] -- field is sensitive see writup in sharepoint for an example of how complicated it can get
            , z.C_Gender1 AS [Gender] 
            , 0 [MergedRecordFlag]
            , NULL [MergedIntoSSID]
            ...
            , NULL AS [Suffix]
            , z.C_FirstAndLastName AS [Fullname]
            ...
            , 0 AS IsBusiness
			, 0 AS IsDeleted
            , CASE WHEN ISNULL(CAST(z.C_STH_Account_Number1 AS NVARCHAR(100)),'') != '' THEN CONCAT('TM-',CAST(z.C_STH_Account_Number1 AS INT)) ELSE 'ELO-' + CAST(z.ID AS NVARCHAR(100)) END AS [Customer_Matchkey] 
