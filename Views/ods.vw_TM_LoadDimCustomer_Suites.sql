...
CREATE VIEW [ods].[vw_TM_LoadDimCustomer_Suites] AS (
...
--base set
		SELECT 
			'Bears_Suites' AS [SourceDB]
			, (SELECT Bears_Suites.etl.fnGetClientSetting('TM-SourceStyem')) AS [SourceSystem]
